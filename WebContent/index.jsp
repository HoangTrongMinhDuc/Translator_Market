			...
			<section class="about" id="about">
				<div class="container" >
					<div class="row">
						...
						<div class="row posts " style="font-family: Arial;border: 1px solid #95a09a; border-radius: 5px; padding: 10px; padding-left: 70px; background-color: #f4f9f6;margin: 10px;">
							<div class="col-md-7">
								<div class="row">
									<div>
										<img class="img-circle" width="50" height="50" src="images/about1.jpg">
										<label class="">user name</label>
									</div>
								</div>
								<div class="row col-md-12">
									<h4>Cần thuê người dịch Anh - Việt làm lâu dài</h4>
								</div>
								<div class="row">
									<div class="col-md-4">
									...
									<div class="col-md-4" style="border: 1px solid #42f48f;color: #42f48f">
										Đang nhận báo giá
									</div>
								...
								<div class="row col-md-12">
									...
									Tôi cần dịch Anh- Việt dịch lâu dài những nội dung liên quan đến những vấn đề sinh hoạt hằng ngày...<a href="#">xem thêm</a>
								</div>
							</div>
							<div class="col-md-5">
								<div class="row col-md-12">
